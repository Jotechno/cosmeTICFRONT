...
const url = "https://cosmeticback.onrender.com/proveedores"
    ...
    .then(function (data) {
      ...
      return listaProveedores.map(function (proveedor) {
        ...
        respuesta += `<tr><td>${proveedor._id}</td>` +
          ...
          <a class='btn btn-danger' onclick='eliminar("${proveedor._id}")'><i class="fa-solid fa-trash-can"></i></a></td></tr>`
...
const actualizar = async () => {
  ...
  if (validateNombreResult && validateCorreoResult && validateDireccionResult && validateTelefonoResult && validateEstadoResult) {
    let proveedor = {
      nit_cedula: _cedula,
